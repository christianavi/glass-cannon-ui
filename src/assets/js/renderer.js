...
function init() {
	...
	if (isPresence) {
		...
		document.querySelector('.modal-footer-button-label').style.display =
      'block';
		document.querySelector('.modal-footer-button-label').innerHTML =
      'Start rich presence';
		...
		if (!document.querySelector('#clientId').value) {
			...
			document.querySelector('#clientId-input-title').innerHTML =
        'Client ID - <span class="error">Please enter a valid Client ID.</span>';
			document.querySelector('.bounce').style.display = 'none';
			document.querySelector('.modal-footer-button-label').style.display =
        'block';
			document.querySelector('.modal-footer-button-label').innerHTML =
		...
		const buttons = [];
		if (
			document.querySelector('#buttonOneLabel').value &&
      document.querySelector('#buttonOneUrl').value
		) {
			buttons.push({
			...
			if (
				document.querySelector('#buttonTwoLabel').value &&
        document.querySelector('#buttonTwoUrl').value
			) {
				buttons.push({
